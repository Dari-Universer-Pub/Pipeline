...
# PROMPT SPÉCIALISÉ — asset : Icône Fragment de souvenir
...
- Dimensions de l'entité : 16×16 px.
...
Produis la **spécification de production** de l'asset `asset_icone_objet_fragment_de_souvenir`
(famille `famille_objets`). L'asset doit être visuellement cohérent avec sa
