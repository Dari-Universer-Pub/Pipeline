...
Séquence `marche` de `joueur_jardinier` — 4 animations :
- `anim_joueur_jardinier_marche_down` direction=down frames=4 fps=8 loop=True impact=None effet=None
- `anim_joueur_jardinier_marche_up` direction=up frames=4 fps=8 loop=True impact=None effet=None
- `anim_joueur_jardinier_marche_left` direction=left frames=4 fps=8 loop=True impact=None effet=None
- `anim_joueur_jardinier_marche_right` direction=right frames=4 fps=8 loop=True impact=None effet=None
...
(action `marche`, direction `toutes (séquence)`). L'animation doit être
