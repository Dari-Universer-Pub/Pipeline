<!-- statut: OK -->
<!-- généré par prompt_gen.py (injecteur de contexte) -->
...
# PROMPT SPÉCIALISÉ — famille : famille_cultures
...
Famille `famille_cultures` — 24 membres interdépendants.
...
Produis **toute la famille visuelle** `famille_cultures` de manière cohérente. Les
...
- `asset_culture_floraison_d_echo_semis` (Floraison d'Écho — semis) — 16×24, variantes ['semis']
- `asset_culture_floraison_d_echo_pousse` (Floraison d'Écho — pousse) — 16×24, variantes ['pousse']
- `asset_culture_floraison_d_echo_mature` (Floraison d'Écho — mature) — 16×24, variantes ['mature']
- `asset_culture_floraison_d_echo_recoltable` (Floraison d'Écho — recoltable) — 16×24, variantes ['recoltable']
- `asset_culture_navet_de_la_vallee_semis` (Navet de la Vallée — semis) — 16×24, variantes ['semis']
- `asset_culture_navet_de_la_vallee_pousse` (Navet de la Vallée — pousse) — 16×24, variantes ['pousse']
- `asset_culture_navet_de_la_vallee_mature` (Navet de la Vallée — mature) — 16×24, variantes ['mature']
- `asset_culture_navet_de_la_vallee_recoltable` (Navet de la Vallée — recoltable) — 16×24, variantes ['recoltable']
- `asset_culture_ble_des_epis_semis` (Blé des Épis — semis) — 16×24, variantes ['semis']
- `asset_culture_ble_des_epis_pousse` (Blé des Épis — pousse) — 16×24, variantes ['pousse']
- `asset_culture_ble_des_epis_mature` (Blé des Épis — mature) — 16×24, variantes ['mature']
- `asset_culture_ble_des_epis_recoltable` (Blé des Épis — recoltable) — 16×24, variantes ['recoltable']
- `asset_culture_courge_des_brumes_semis` (Courge des Brumes — semis) — 16×24, variantes ['semis']
- `asset_culture_courge_des_brumes_pousse` (Courge des Brumes — pousse) — 16×24, variantes ['pousse']
- `asset_culture_courge_des_brumes_mature` (Courge des Brumes — mature) — 16×24, variantes ['mature']
- `asset_culture_courge_des_brumes_recoltable` (Courge des Brumes — recoltable) — 16×24, variantes ['recoltable']
- `asset_culture_lin_du_repos_semis` (Lin du Repos — semis) — 16×24, variantes ['semis']
- `asset_culture_lin_du_repos_pousse` (Lin du Repos — pousse) — 16×24, variantes ['pousse']
- `asset_culture_lin_du_repos_mature` (Lin du Repos — mature) — 16×24, variantes ['mature']
- `asset_culture_lin_du_repos_recoltable` (Lin du Repos — recoltable) — 16×24, variantes ['recoltable']
- `asset_culture_souci_de_la_vallee_semis` (Souci de la Vallée — semis) — 16×24, variantes ['semis']
- `asset_culture_souci_de_la_vallee_pousse` (Souci de la Vallée — pousse) — 16×24, variantes ['pousse']
- `asset_culture_souci_de_la_vallee_mature` (Souci de la Vallée — mature) — 16×24, variantes ['mature']
- `asset_culture_souci_de_la_vallee_recoltable` (Souci de la Vallée — recoltable) — 16×24, variantes ['recoltable']

## 9. Format de réponse attendu

```json
{
  "family": "famille_cultures",
  "shared": {
