...
> Une version précédente de cet élément a été REJETÉE. Corrige UNIQUEMENT les erreurs listées, sans modifier le reste, sans changer l'identifiant interne ni un nom canonique. Si une information manque toujours, réponds `BLOCKED: <raison>`.
