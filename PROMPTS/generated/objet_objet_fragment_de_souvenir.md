...
# PROMPT SPÉCIALISÉ — objet : Fragment de souvenir
...
```json
{
  "id": "objet_fragment_de_souvenir",
  "display_name": "Fragment de souvenir",
  "status": "CANONIQUE",
  "category": "fragment",
  "source": "INPUT/canon_initial.md#Objets canoniques",
  "justification": "Fragment de souvenir canonique ; unité narrative du système mémoire.",
  "function": "Fragment de souvenir canonique ; unité narrative du système mémoire.",
  "gameplay_verb": "commemorer",
  "obtention": [
    "canon"
  ],
  "loop_stage": 4,
...
- Relations entrantes (ce qui pointe vers l'entité) :
  - `machine_puits_de_memoire` —[produit]→ **objet_fragment_de_souvenir**
  - `recette_fragment_ravive` —[transforme]→ **objet_fragment_de_souvenir**
  - `system_memoire` —[utilise]→ **objet_fragment_de_souvenir**
  - `system_relations` —[utilise]→ **objet_fragment_de_souvenir**
  - `creature_echo_du_bois` —[produit]→ **objet_fragment_de_souvenir**
  - `quete_le_premier_echo` —[affecte]→ **objet_fragment_de_souvenir**
  - `quete_ce_qui_se_repete` —[affecte]→ **objet_fragment_de_souvenir**
  - `fait_fragments_physiques` —[decrit]→ **objet_fragment_de_souvenir**
...
Produis la **fiche de production complète** de l'objet `objet_fragment_de_souvenir`, ainsi
